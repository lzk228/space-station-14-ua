...
class LokaliseFluentAstComparerManager:
    ...
    def for_delete(self):
        ...
        if len(for_delete):
            ...
            print(f'Наступні ключі є в lokalise, але немає у файлі. Можливо, їх потрібно видалити з lokalise: {keys}')
    ...
    def for_create(self):
        ...
        if len(for_create):
            ...
            print(f'Наступних ключів файлу немає в lokalise. Необхідно додати: {keys}')
