...
class Project:
    def __init__(self):
        ...
        self.uk_locale_dir_path = os.path.join(self.locales_dir_path, 'uk-UA')
        ...
        self.en_locale_prototypes_dir_path = os.path.join(self.en_locale_dir_path, 'ss14-uk', 'prototypes')
        self.uk_locale_prototypes_dir_path = os.path.join(self.uk_locale_dir_path, 'ss14-uk', 'prototypes')
